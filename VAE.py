...
trainset = torchvision.datasets.MNIST(root='./image', train=True, download=True, transform=transform)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=128, shuffle=True)

testset = torchvision.datasets.MNIST(root='./image', train=False, download=True, transform=transform)
